...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> sendUssdRequest() async {
    ...
    try {
      ...
      responseMessage = await UssdService.makeRequest(_subscriptionId, _requestCode);
      setState(() {
              ...
              children: <Widget>[
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Subscription ID (SIM Card Slot)',
                  ),
                  keyboardType: TextInputType.number,
                  onChanged: (newValue) {
                    setState(() {
                      _subscriptionId = int.tryParse(newValue) ?? 1;
                    });
                  },
                ),
